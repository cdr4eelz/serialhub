...
# -*- coding: utf-8 -*-
#
# serialhub documentation build configuration file
#
...
_version_py = os.path.join(repo, 'serialhub', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'serialhubdoc'
...
latex_documents = [
    (master_doc, 'serialhub.tex', 'serialhub Documentation',
     'cdr4eelz', 'manual'),
]
